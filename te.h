...
//extern void CrtOut();
extern void CrtClear();
extern void CrtLocate();
extern void CrtClearLine();
extern int GetKey();
extern int ReadLine();
extern int GetFirstLine();
extern int GetLastLine();
extern void CrtReverse();
extern void CrtClearEol();
extern int MenuNew();
extern int MenuOpen();
extern int MenuSave();
extern int MenuSaveAs();
extern int MenuInsert();
extern void MenuAbout();
extern void MenuHelp();
extern int MenuExit();
extern void NewFile();
extern int ReadFile();
...
extern int MacroRunning();
extern void ForceChLeft();
extern int ForceStr();
extern int ForceCh();
extern int ModifyLine();
extern void MacroGet();
extern int GetScrConf();
extern void CrtSetup();
extern void CrtReset();
extern void Loop();
extern void LoopUp();
extern void LoopDown();
extern void LoopCr();
extern void LoopLeftDel();
extern void LoopRightDel();
extern void LoopPgUp();
extern void LoopPgDown();
extern void LoopTop();
extern void LoopBottom();
extern void LoopCopy();
extern void LoopCut();
extern void LoopPaste();
extern void LoopDelete();
extern void LoopClrClp();
extern void LoopBlkStart();
extern void LoopBlkEnd();
extern int LoopFindFirst();
extern void LoopFindNext();
extern void LoopGoLine();
extern void LoopMacro();
extern int LoopCopyEx();
extern void LoopDeleteEx();
extern void LoopGo();
